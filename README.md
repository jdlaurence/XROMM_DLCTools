...
The file Workflow_Instructions.pdf contains an **OUTDATED** step-by-step walk through of the process. I am in the process of updating the instruction.md document. Stay tuned. The default workflow involves training a single network that will analyze videos from both camera planes. If you want to train seperate networks for each camera plane, use the 2Networks Jupyter Notebook.
